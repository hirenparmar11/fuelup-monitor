...
import com.fuelup.monitor.service.TransactionService;
...
public class TransactionController {
	...
	public ResponseEntity<Transaction> fetchTransaction(@PathVariable Long transactionId) {
		Transaction transaction = transactionService.fetchTransaction(transactionId);
		if(transaction != null ) {
	...
	public ResponseEntity<Transaction> modifyTransaction(@PathVariable Long transactionId, @RequestBody Transaction transaction) {
		Transaction modifiedTransaction = transactionService.modifyTransaction(transactionId, transaction);
